...
This chapter asks how to discuss striking formal resemblances without turning
resemblance into evidence. Its importance is methodological: it separates
visual analogy from a testable account of form spaces, null models, and
generative constraints. The aim is to keep the question mathematically useful
while avoiding speculative historical inference.
