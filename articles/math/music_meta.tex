...
\newcommand{\Rhy}{\mathbf{Rhy}}
\newcommand{\Mel}{\mathbf{Mel}}
\newcommand{\Harm}{\mathbf{Harm}}
\newcommand{\Pitch}{\mathbf{Pitch}}
\newcommand{\Disc}{\mathbf{Disc}}
\newcommand{\Frame}{\mathfrak{A}}
\newcommand{\op}{^{\mathrm{op}}}
\newcommand{\R}{\mathbb{R}}
\newcommand{\Z}{\mathbb{Z}}
\newcommand{\N}{\mathbb{N}}
\newcommand{\Xmus}{X_{\mathrm{mus}}}

\title{The 2-Categorical Position of Music\\
Among Time-Value Art Forms}
...
\begin{abstract}
\noindent We promote the parameter pair $(\B, \V)$ of the previous
framework to a variable and organise the resulting time-value art
...
$\Frame(X, \Xmus)$: it admits faithful musicalisations, fully
faithful ones, none. We classify several borderline cases — paired
...
This article treats music as a structural predicate rather than as an intuitive
label. By encoding temporal organization and value systems as categorical data,
it asks which mappings make an art form musical and which assumptions a verdict
depends on. The goal is not to settle every aesthetic case, but to make the
source of each disagreement visible in the formal model.

% =====================================================================
\section{From parameters to a 2-category of frames}
% =====================================================================

The previous framework parametrises rhythm, melody, and harmony by a
pair $(\B, \V)$ of small categories. It treats the pair as fixed.
Here we let it vary.
...
% =====================================================================
\section{Conclusion: What the Framework Refuses to Decide}
% =====================================================================
