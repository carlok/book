...
\title{The Limit $\displaystyle\lim_{z \to a} \frac{z^n - a^n}{z - a}$ \\ in the Complex Plane}
...
This article uses a familiar difference quotient to expose why complex
...
holomorphic behavior from global multivaluedness.
