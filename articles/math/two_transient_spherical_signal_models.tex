...
The models in this article ask how much of a transient expanding signal can be
captured with rational functions rather than exponential or Gaussian profiles.
This matters because rational models are often easier to inspect algebraically,
compare asymptotically, and embed in later symbolic or computational workflows.
