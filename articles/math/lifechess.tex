...
\begin{document}
	...
	LifeChess proposes a game-design architecture in which strategic play is
	built on evolved cellular-automaton dynamics rather than hand-authored piece
	rules. The framework separates the search for viable automata from the later
	two-player game, preserving emergent substrate behavior while giving players
	a finite and readable strategic interface. Its value is exploratory: it
	offers a concrete route from artificial-life dynamics to playable
